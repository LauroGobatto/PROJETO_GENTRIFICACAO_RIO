...
df.columns = ['BAIRRO', 'PREÇO POR METRO QUADRADO', 'UNIDADES RESIDENCIAIS', 'ÍNDICE DE PRESSÃO', 'ÁREA TERRITORIAL DISPONÍVEL', 'MAGNITUDE', 'ÍNDICE DE INFORMALIDADE', 'RENDA MENSAL', 'TAXA DE ESFORÇO', 'LATITUDE', 'LONGITUDE', 'RISCO TARGET', 'RISCO DE GENTRIFICAÇÃO']
