...
df.columns = ['BAIRRO', 'PREÇO_POR_METRO', 'UNIDADES_RESIDENCIAIS', 'INDICE_DE_PRESSAO', 'AREA_TERRITORIAL_DISPONIVEL', 'MAGNITUDE', 'INDICE_INFORMALIDADE', 'RENDA_MENSAL', 'TX_ESFORCO','LATITUDE', 'LONGITUDE','RISCO TARGET', 'RISCO_GENTRIFICACAO']
